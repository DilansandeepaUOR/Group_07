        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <Link to="/appointment" className="block">
              <div className="bg-white/10 backdrop-blur-md rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 h-full">
                <div className="p-8 flex flex-col items-center h-full">
                  <div className="bg-[#A6E3E9] text-[#22292F] rounded-full p-6 mb-6">
                    <FaClinicMedical className="text-5xl" />
                  </div>
                  <h2 className="text-2xl font-bold text-[#A6E3E9] mb-4">Clinic Appointment</h2>
                  ...
                  <div className="mt-auto">
                    <button className="bg-[#A6E3E9] text-[#22292F] px-6 py-3 rounded-lg font-bold shadow-md transition duration-300 hover:bg-[#71C9CE]">
                      Book Clinic Visit
                    </button>
                  </div>
                </div>
            ...
            <Link to="/mobileservice" className="block">
              <div className="bg-white/10 backdrop-blur-md rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 h-full">
                <div className="p-8 flex flex-col items-center h-full">
                  ...
                  <h2 className="text-2xl font-bold text-[#A6E3E9] mb-4">Mobile Service</h2>
                  <p className="text-gray-200 text-center mb-6">
