...
function Home() {
  ...
  return (
    ...
    <section id="home">
      {/* <!-- Main home section --> */}
      <div className="container mx-auto px-6 py-16 bg-gradient-to-b from-[#22292F] via-[#028478] to-[#46dfd0] text-white">
        <div className="flex flex-wrap items-center justify-between">
          ...
          <div className="w-full lg:w-5/12 flex justify-center items-center">
            <img src={mainimage} alt="Dog1" className="w-96 rounded-xl shadow-lg" />
          </div>
        </div>
      </div>
