      ...
      {isAuthenticated ? (
        <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl mb-6">
          ...
          <div className="mt-6 flex justify-end">
            <button
              className="px-6 py-2 rounded-md bg-[#A6E3E9] text-[#22292F] hover:bg-[#71C9CE] font-bold transition duration-300"
    ...
    return (
      <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl mb-6">
        ...
        <div className="mt-8 flex justify-between">
          <button
            className="px-6 py-2 rounded-md bg-gray-200/20 text-gray-200 hover:bg-gray-200/30 font-bold transition duration-300"
            onClick={() => setActiveTab("pet-info-and-service")}
          >
            Back
          </button>
          <button
            className="px-6 py-2 rounded-md bg-[#A6E3E9] text-[#22292F] hover:bg-[#71C9CE] font-bold transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
